        ...
        <tr>
            ...
            <td>
                <div class="table-actions">
                    <button class="action-btn" style="background: #10b981; color: white;" onclick="navigateToPayments('${tenant.id}')" title="עבור לתשלומים של דייר זה">
                        <i class="fas fa-money-bill-wave"></i>
                    </button>
                    <button class="action-btn" style="background: #6366f1; color: white;" onclick="openMonthlyTracking('${tenant.id}')" title="מעקב חודשי">
                        <i class="fas fa-calendar-check"></i>
                    </button>
                    <button class="action-btn view" onclick="viewTenant('${tenant.id}')" title="צפה">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="action-btn edit" onclick="editTenant('${tenant.id}')" title="ערוך">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="action-btn delete" onclick="deleteTenant('${tenant.id}')" title="מחק">
