...
function setupNavigation() {
    ...
    menuItems.forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            // Call the existing switchTab function so it handles both main and bottom nav synchronization
...
function switchTab(tabName) {
    ...
    if (menuItem) {
        ...
        document.querySelectorAll('.bottom-nav-item').forEach(ni => ni.classList.remove('active'));
        const bottomNavItem = document.querySelector(`.bottom-nav-item[data-section="${tabName}"]`);
        if (bottomNavItem) {
